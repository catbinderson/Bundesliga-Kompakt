const CACHE="ligakompakt-v1.0.0-final",ASSETS=["./","index.html","info.html","einladen.html","styles.css?v=1.0.0-fix1","app.js?v=1.0.0","share-fix.js?v=2","manifest.webmanifest","icon.svg","icon-192.png","icon-512.png","icon-maskable-512.png","apple-touch-icon.png","qr-ligakompakt.png","social-preview.jpg","version.json"];
