const CACHE="ligakompakt-v1.0.0-final-admin1",ASSETS=["./","index.html","info.html","einladen.html","teilen.html","statistik.html","admin.html","styles.css?v=1.0.0-fix1","app.js?v=1.0.0","tips-persistence.js?v=1","share-fix.js?v=2","manifest.webmanifest","icon.svg","icon-192.png","icon-512.png","icon-maskable-512.png","apple-touch-icon.png","qr-ligakompakt.png","social-preview.jpg","facebook-preview-v5.jpg","version.json"];
