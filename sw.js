const CACHE="ligakompakt-official-v1.0.0",ASSETS=["./","index.html","info.html","einladen.html","styles.css?v=1.0.0","app.js?v=1.0.0","manifest.webmanifest","icon.svg","icon-192.png","icon-512.png","icon-maskable-512.png","apple-touch-icon.png","qr-ligakompakt.png","version.json"];
